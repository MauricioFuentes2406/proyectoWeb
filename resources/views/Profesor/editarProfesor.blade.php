...
@section('cont')
    @if( Auth::User()->tipoUsuario==1 and Auth::User()->tipoUsuario==3 )  
...
<form action="/editProf/{{$User->id}}" method="POST" role="form">
{{csrf_field()}}
...
<div class="form-group">
    ...
    <input type="text" name="email" class="form-control" value="{{$User->email}}" required autofocu>
</div> 
